...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Post.wordpress_username'
        db.add_column('publisher_post', 'wordpress_username', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Changing field 'Post.remote_url'
        db.alter_column('publisher_post', 'remote_url', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Deleting field 'Post.wordpress_username'
        db.delete_column('publisher_post', 'wordpress_username')

        # Changing field 'Post.remote_url'
        db.alter_column('publisher_post', 'remote_url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
